---
title: "To find whether customer has a term deposit account or not"
...
results3 <- record_performance(results3, "duration+balance_group_poutcome", svm(y ~duration+balance_group+poutcome, data=training_data), test_data)



#final svm model
fsm <- svm(y ~ duration+balance_group+poutcome, data=training_data)
svm.pred <- predict(fsm, test_data)
